  ...
  <body class="size-1280">
    ...
    <main role="main">
      ...
      <header class="section-top-padding background-image text-center" style="background-image:url(img/img-05.jpg)">
        ...
        <p class="text-white">We are a group of 4 highly passionate high school students experienced with Big Data<br>
          and are determined to bring about change with our skills</p>
