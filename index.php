    ...
    <main role="main">
      ...
      <header class="section-top-padding background-image text-center" style="background-image:url(img/img-05.jpg)">
        ...
        <p class="text-white">Influx Analytics believes in letting the data speak for itself.<br>
          ...
          By delivering accessible and relavent information, we hope to incite prosocial, sustainable change. </p>
        <i class="slow icon-sli-arrow-down text-white margin-top-20 text-size-16"></i>
        <!-- Image -->
        <img class="margin-top-20 center" src="img/Big-Data-Template.png" alt="">
      ...
      <section class="background-primary full-width">
        <div class="m-12 l-6 xl-5 xxl-4">
          <img style="height: 450px; object-fit: cover" src="img/reopening.jpg"/>
        </div>
